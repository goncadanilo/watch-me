...
Nesse desafio, precisei refatorar uma aplicação já pronta para melhorar a componentização da mesma. O objetivo foi dividir a aplicação em componentes, que sejam reutilizáveis. Dessa forma, pude treinar os conceitos aprendidos no módulo: **Fundamentos do ReactJS**.
